...
public class GeneratePayload {
	...
	//ADDED 12/2/2015
	//same as main(), but returns serialized object in byte[] instead of printing to stdout, and will not throw exceptions
	public static byte[] getPayload(String type,String command) {
